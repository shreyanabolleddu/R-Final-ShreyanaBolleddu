...
We are going to focus on the neurochemical profiles, so we are gonna to create a subset of the relevant data.
...
Next, we will display summary statistics regarding this information. Also, checked for statistical significance between the 3 groups (healthy, early, advanced).
